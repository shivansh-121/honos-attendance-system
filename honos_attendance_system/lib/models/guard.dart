class Guard {
  ...
  final String phone, dob, address, aadharNo, aadharPhoto;
  ...
  const Guard({
    ...
    this.aadharNo = '', this.aadharPhoto = '', this.bankName = '',
  ...
  Map<String, dynamic> toJson() => {
    ...
    'aadharPhoto': aadharPhoto, 'bankName': bankName, 'accountNo': accountNo,
  ...
  factory Guard.fromJson(Map<String, dynamic> j) => Guard(
    ...
    bankName: j['bankName'] ?? '', accountNo: j['accountNo'] ?? '',
