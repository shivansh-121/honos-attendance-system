class Attendance {
  ...
  final String checkOutTime, checkOutPhotoPath;
  ...
  const Attendance({
    ...
    this.checkOutTime = '', this.checkOutPhotoPath = '',
  ...
  Map<String, dynamic> toJson() => {
    ...
    'checkOutTime': checkOutTime, 'checkOutPhotoPath': checkOutPhotoPath,
    'lat': lat, 'lng': lng,
  };
  ...
  factory Attendance.fromJson(Map<String, dynamic> j) => Attendance(
    ...
    markedAt: j['markedAt'] ?? '',
    checkOutTime: j['checkOutTime'] ?? '', checkOutPhotoPath: j['checkOutPhotoPath'] ?? '',
