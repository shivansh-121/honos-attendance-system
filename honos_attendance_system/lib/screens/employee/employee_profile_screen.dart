            ...
            leavesAsync.when(
              data: (leaves) {
                final myLeaves = leaves
                    .where((l) =>
                        l.employeeId == user.id && l.status == 'approved')
                    .length;
                  ...
                  _InfoCard(
                    ...
                    children: [
                      ...
                      _InfoRow(
                          icon: Icons.badge,
                          label: 'Employee ID',
                          value: user.empId.isNotEmpty ? user.empId : '--'),
                      _InfoRow(
                  ...
                  _InfoCard(
                    ...
                    children: [
                      _InfoRow(
                          ...
                          label: 'Fixed Salary',
                          value: '₹${user.salary.toStringAsFixed(0)}'),
                      _InfoRow(
                          icon: Icons.account_balance,
                          label: 'Bank Name',
                          value:
                              user.bankName.isNotEmpty ? user.bankName : '--'),
                      _InfoRow(
                          icon: Icons.numbers,
                          label: 'Account No.',
                          value: user.accountNo.isNotEmpty
                              ? user.accountNo
                              : '--'),
                      _InfoRow(
                          icon: Icons.account_balance_wallet,
                          label: 'IFSC Code',
                          value: user.ifsc.isNotEmpty ? user.ifsc : '--'),
                    ],
                  ),
          ...
          children: [
                ...
                if (attRecord.isNotEmpty) {
                  ...
                  if (checkDate
                    ...
                    blockColor = context.colors.red
                        .withValues(alpha: 0.3); // Missed attendance
                  }
                }
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 16),
                _buildLegendItem(
                    context.colors.red.withValues(alpha: 0.3), 'Missed'),
                const SizedBox(width: 16),
