  ...
  Future<void> _addNewSite(BuildContext context) async {
    ...
    await showDialog(
      ...
      builder: (ctx) => AlertDialog(
          ...
          children: [
            Container(
              ...
              child: Text(
                  ...
                  style: TextStyle(color: context.colors.green, fontSize: 13, fontWeight: FontWeight.bold)),
            ),
        ...
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(ctx), child: Text('Cancel', style: TextStyle(color: context.colors.txtSec))),
          ElevatedButton(
            style: ElevatedButton.styleFrom(foregroundColor: context.colors.bgBase, backgroundColor: context.colors.primary, ),
            onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text('Pin New Site', style: TextStyle(color: context.colors.bgBase, fontWeight: FontWeight.bold)),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: Text('Sites & Geofencing', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 20, letterSpacing: -0.5)),
              background: Stack(
                fit: StackFit.expand,
                children: [
                  Container(
                  ...
                  Positioned(
                    ...
                    child: Transform.rotate(
                      angle: -0.1,
                      child: Icon(Icons.apartment_rounded, size: 140, color: Colors.white.withValues(alpha: 0.15)),
                ...
                return SliverFillRemaining(
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.location_off_rounded, size: 80, color: context.colors.txtMuted.withValues(alpha: 0.3)).animate().scale(delay: 200.ms, duration: 400.ms, curve: Curves.easeOutBack),
                        const SizedBox(height: 20),
                        Text('No sites found.', style: TextStyle(color: context.colors.txtSec, fontSize: 18, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                );
                    ...
                    (ctx, i) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(color: context.colors.primary.withValues(alpha: 0.05), blurRadius: 20, offset: const Offset(0, 8)),
                          ],
                        ),
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(site.name,
                                          style: TextStyle(fontWeight: FontWeight.bold, color: context.colors.txtPrimary, fontSize: 18, letterSpacing: -0.3)),
                            ...
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Icon(Icons.location_on, size: 16, color: context.colors.txtMuted),
                                const SizedBox(width: 8),
                                Expanded(child: Text(site.address, style: TextStyle(color: context.colors.txtSec, fontSize: 13))),
                              ],
                            ),
                            const SizedBox(height: 20),
                            Row(
                              children: [
                                Expanded(
                                  child: FilledButton.icon(
                                    ...
                                    label: const Text('Adjust Radius', style: TextStyle(fontWeight: FontWeight.bold)),
                                  ),
                                ),
                                    ...
                                    onPressed: () async {
                                      final confirm = await showDialog<bool>(
                                        ...
                                        builder: (ctx) => AlertDialog(
                                          backgroundColor: context.colors.bgSurface,
                                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                                          title: Text('Delete Site', style: TextStyle(color: context.colors.txtPrimary, fontWeight: FontWeight.bold)),
                                          content: Text('Are you sure you want to delete this site?', style: TextStyle(color: context.colors.txtSec)),
                                          actions: [
                                            TextButton(onPressed: () => Navigator.pop(ctx, false), child: Text('Cancel', style: TextStyle(color: context.colors.txtSec))),
                                            TextButton(onPressed: () => Navigator.pop(ctx, true), child: Text('Delete', style: TextStyle(color: context.colors.red, fontWeight: FontWeight.bold))),
                                          ],
                                        ),
                                      );
                                      if (confirm == true) {
                      ...
                      ).animate().fadeIn(delay: (40 * i).ms).slideY(begin: 0.1, end: 0, duration: 400.ms, curve: Curves.easeOut);
                    },
