...
class _AdminDashboardScreenState extends ConsumerState<AdminDashboardScreen> {
                ...
                Row(
                  children: [
                    Text('ADMIN DASHBOARD',
                        style: TextStyle(
                                fontSize: 13, color: context.colors.txtSec)
                            .copyWith(
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                                letterSpacing: 1)),
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _buildActionButton(
                        ...
                        textColor: context.colors.txtPrimary,
                        onTap: () => AppNav.push(context,
                            const ManageSupervisorsScreen(role: 'executive'))),
                    _buildActionButton(
                        title: 'Employees',
                        icon: Icons.computer,
                        color: context.colors.bgSurface,
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _buildDrawerItem(
                      Icons.event_available, 'Leave Approvals', false, () {
                    Navigator.pop(context);
                    AppNav.push(context, const AdminLeavesScreen());
                  }),
                  _buildDrawerItem(
                  ...
                  _buildDrawerItem(
                      Icons.edit_calendar, 'Manual Attendance', false, () {
                    Navigator.pop(context);
  ...
  Widget _buildSectionLabel(String label) {
    return Padding(
      ...
      child: Text(label,
          style: TextStyle(
              color: context.colors.txtPrimary.withValues(alpha: 0.3),
              fontSize: 10,
              fontWeight: FontWeight.bold,
              letterSpacing: 1.5)),
    );
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: isSelected
              ? Border.all(color: context.colors.green.withValues(alpha: 0.4))
              : null,
        ),
        child: Row(
          children: [
