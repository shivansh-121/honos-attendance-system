...
class _GuardProfileScreenState extends ConsumerState<GuardProfileScreen> {
                  ...
                  onPressed: () async {
                    final ok = await showDialog<bool>(
                      ...
                      builder: (c) => AlertDialog(
                        ...
                        content: Text(
                            'Are you sure you want to permanently delete ${widget.guard.name}? This cannot be undone.'),
                        actions: [
                          TextButton(
        ...
        child: Column(
          ...
          children: [
            ...
            attendanceAsync.when(
              data: (allAttendance) {
                final guardAttendance = allAttendance
                    .where((a) => a.guardId == widget.guard.id)
                    .toList();
                return Column(
                  children: [
          ...
          children: [
            Hero(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: widget.guard.photo.length > 200
                    ? MemoryImage(base64Decode(widget.guard.photo))
                    : null,
                child: widget.guard.photo.length <= 200
                    ? Text(widget.guard.name[0],
                        style: TextStyle(
                            fontSize: 28,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.badge,
                          size: 14, color: context.colors.txtMuted),
                      const SizedBox(width: 4),
                      Text('ID: ${widget.guard.empId}',
                          style: TextStyle(
                  ...
                  sitesAsync.when(
                    data: (sites) {
                      final siteMatches =
                          sites.where((s) => s.id == widget.guard.siteId);
                      final siteName = siteMatches.isNotEmpty
                          ? siteMatches.first.name
                          : 'Unknown Site';
                      return Row(
                        children: [
                          Icon(Icons.business,
  ...
  Widget _buildAdvancesSection(AsyncValue<List<dynamic>> advancesAsync) {
    return advancesAsync.when(
      data: (allAdvances) {
        ...
        final totalAdvance =
            monthAdvances.fold<double>(0, (sum, a) => sum + a.amount);
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Text('Advances Taken',
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold,
                            color: context.colors.txtPrimary)),
                    Text('Total: INR ${totalAdvance.toStringAsFixed(0)}',
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                ...
                if (monthAdvances.isEmpty)
                  Text('No advances taken this month.',
  ...
  Widget _buildMetricsSection(List<Attendance> attendance) {
    ...
    final totalPresent =
        attendance.where((a) => a.status.toLowerCase() == 'present').length;
    final double credibilityScore =
        totalPossibleDays > 0 ? (totalPresent / totalPossibleDays) * 100 : 0;
    ...
    final monthPresentDays = currentMonthAtt
            ...
            children: [
              ...
              Expanded(
                  child: Text(value.isEmpty ? '—' : value,
                      style: TextStyle(
                          color: valueColor ?? context.colors.txtPrimary,
                          fontSize: 13,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            divider(),
            row(Icons.currency_rupee, 'Monthly Salary',
                g.salary > 0 ? '₹${g.salary.toStringAsFixed(0)}' : '—',
          ...
          children: [
            ...
            GridView.builder(
              ...
              itemBuilder: (ctx, index) {
                ...
                final attRecord =
                    attendance.where((a) => a.date == dateStr).toList();

                Color blockColor = context.colors.bgElevated; // Default/No data

                if (attRecord.isNotEmpty) {
                  final isPresent =
                      attRecord.any((a) => a.status.toLowerCase() == 'present');
                  blockColor =
                  ...
                  if (checkDate
                    ...
                    blockColor =
                        context.colors.red; // Missed attendance is now also red
                  }
                }
