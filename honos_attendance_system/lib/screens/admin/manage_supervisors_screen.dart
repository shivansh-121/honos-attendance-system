      ...
      builder: (ctx) {
        ...
        return StatefulBuilder(
          builder: (ctx, setSheetState) {
            final filteredSites = sites.where((s) => s.name.toLowerCase().contains(query.toLowerCase()) || s.address.toLowerCase().contains(query.toLowerCase())).toList();
            return Container(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (widget.role == 'supervisor' || widget.role == 'employee') ...[
