...
import '../../widgets/theme_toggle_button.dart';import '../../models/site.dart';
...
class _ExecutiveDashboardScreenState extends ConsumerState<ExecutiveDashboardScreen> {
  ...
  Future<void> _uploadPhoto(AppUser user) async {
    ...
    try {
      ...
      _checkPhotoStatus();
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: const Text('Profile picture updated!'), backgroundColor: NLTheme.accentGreen));
    } catch (e) {}
  }
