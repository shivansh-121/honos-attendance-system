        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: const Text('Guards Management', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 20, letterSpacing: -0.5)),
              background: Stack(
                fit: StackFit.expand,
                children: [
                  Container(
          ...
          guardsAsync.when(
            ...
            error: (e, __) => SliverToBoxAdapter(child: Padding(padding: const EdgeInsets.all(40), child: Center(child: Text('Error: $e', style: TextStyle(color: context.colors.red))))),
          ),
        ],
      ),
    );
